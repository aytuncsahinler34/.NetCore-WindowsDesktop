...
namespace BooksDemo
{
	partial class Form3
	{
		...
		private void InitializeComponent() {
			...
			this.label3.Text = "ActualReturnDay:";
			// 
			// textBox3
			// 
			this.textBox3.Enabled = false;
			this.textBox3.Location = new System.Drawing.Point(230, 153);
			...
			this.label4.Text = "RequiredReturnDay:";
			// 
			// textBox4
			// 
			this.textBox4.Enabled = false;
			this.textBox4.Location = new System.Drawing.Point(230, 191);
			...
			this.textBox5.Location = new System.Drawing.Point(230, 233);
